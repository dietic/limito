...
export default function HeroVisual() {
  return (
    <div className="absolute inset-0">
      ...
      <div className="absolute left-[6%] top-[10%] w-[46%] max-w-[520px] rounded-xl border border-border bg-card/90 p-4 shadow-xl backdrop-blur-sm">
      ...
      {/* Recent Links card */}
      <div className="absolute bottom-[10%] right-[6%] w-[44%] max-w-[500px] rounded-xl border border-border bg-card/90 p-4 shadow-xl backdrop-blur-sm">
