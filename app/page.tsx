  ...
  return (
    <div className="relative min-h-screen bg-background">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-xl leading-8 text-muted-foreground">
              Share smarter. Set a time or click limit, track engagement, and let your links retire themselves — beautifully.
            </p>
          ...
          <div className="mx-auto mt-14 max-w-5xl">
            <div className="grid grid-cols-2 items-center gap-6 text-center text-sm text-muted-foreground sm:grid-cols-4">
              <div className="rounded-lg border border-border bg-card/50 px-4 py-3">Fast setup</div>
              <div className="rounded-lg border border-border bg-card/50 px-4 py-3">Edge redirects</div>
              <div className="rounded-lg border border-border bg-card/50 px-4 py-3">Zero tracking bloat</div>
              <div className="rounded-lg border border-border bg-card/50 px-4 py-3">Privacy first</div>
            </div>
          </div>
              ...
              <div className="relative aspect-video overflow-hidden rounded-lg">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="rounded-xl border border-border bg-background/70 px-6 py-4 text-center shadow-sm backdrop-blur">
                    ...
                    <div className="mt-1 text-lg font-semibold text-foreground">limi.to/r/launch</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="border-t border-border bg-muted/40 px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-lg text-muted-foreground">Powerful controls. Minimal effort.</p>
          </div>
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "Time-based expiration",
                description: "Choose an exact date and time. For launches, promos, and events.",
              ...
              },
              {
                ...
                description: "Expire after N clicks. Great for limited access and exclusives.",
              ...
              },
              {
                ...
                description: "See clicks and last activity instantly — no heavy dashboards.",
              ...
              },
              {
                ...
                description: "Global edge network. Sub-100ms target for redirects.",
              ...
              },
              {
                ...
                description: "No pixel soup. Just what you need to manage links.",
              ...
              },
              {
                ...
                description: "Send users to a helpful destination after expiry.",
              ...
              >
                ...
                <h3 className="mt-6 text-lg font-semibold text-card-foreground">{f.title}</h3>
      ...
      <section id="how-it-works" className="px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Create your first link in seconds</h2>
            <p className="mt-4 text-lg text-muted-foreground">Three simple steps to start managing expiring links</p>
          </div>
          <div className="mt-16 grid gap-8 sm:grid-cols-3">
            {[
              { step: "1", title: "Create", desc: "Paste your destination and pick expiration mode" },
              { step: "2", title: "Share", desc: "Copy your short link and send it anywhere" },
              { step: "3", title: "Track", desc: "See clicks and let it expire automatically" },
            ].map((s, i) => (
              <div key={i} className="relative rounded-2xl border border-border bg-card p-6 transition hover:shadow-md">
        ...
        <div className="absolute inset-0 opacity-20 [mask-image:radial-gradient(ellipse_at_center,black,transparent_70%)]">
          <div className="mx-auto h-full max-w-7xl">
            <div className="grid h-full grid-cols-12">
              {Array.from({ length: 12 }).map((_, i) => (
                <div key={i} className="border-l border-primary-foreground/20" />
              ))}
            </div>
          </div>
        </div>
        <div className="relative mx-auto max-w-4xl text-center">
          <h2 className="text-4xl font-bold tracking-tight sm:text-5xl">Ready to take control of your links?</h2>
          <p className="mt-6 text-xl text-primary-foreground/90">Join creators and teams using Limi.to for smarter link sharing</p>
          <div className="mt-10">
            <a href="/login" className="inline-flex items-center gap-2 rounded-lg bg-background px-8 py-4 text-base font-semibold text-foreground shadow-xl transition hover:bg-background/90">
              Start for free
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
      ...
      <footer className="border-t border-border bg-muted px-6 py-12">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-8 border-t border-border pt-8 text-center text-sm text-muted-foreground">© 2025 Limi.to. All rights reserved.</div>
        </div>
      </footer>
    </div>
  );
