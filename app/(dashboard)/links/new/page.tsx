      ...
      <div className="border-b border-border bg-background/70 backdrop-blur-sm">
        <div className="mx-auto max-w-4xl px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Create Link</h1>
        ...
        <div className="mb-8 grid grid-cols-3 gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Where to redirect</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-foreground">Expiration</div>
              <div className="text-xs text-muted-foreground">When to expire</div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground">Customize behavior</div>
            </div>
          </div>
        </div>
