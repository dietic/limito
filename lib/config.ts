...
export const reservedSlugs = new Set([
  'admin','api','r','login','signup','settings','dashboard','terms','privacy','pricing','docs','support','www','static','assets'
])
...
export const config = {
  ...
  plans: {
    free: {
      ...
      analyticsRetentionDays: Number(process.env['FREE_PLAN_ANALYTICS_RETENTION_DAYS'] ?? 7)
    }
  }
}
