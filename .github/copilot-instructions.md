...
- **Frontend**: Next.js App Router (client components in `app/`) + Tailwind CSS
...
- Color palette: Primary `#2d5dc5`, Accent `#f26749`, gradients for premium feel
- Mobile-first: Use `sm:`, `lg:` breakpoints, test at 360px minimum
- Consistent spacing: `p-4`, `mt-6`, `gap-3`
